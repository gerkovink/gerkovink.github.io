...
<<<<<<< Updated upstream
- [`ampute` in `mice`](https://github.com/stefvanbuuren/mice/blob/ampute/R/Ampute.R) - [vignette]( https://github.com/RianneSchouten/Amputation_with_Ampute/blob/master/Vignette/ampute.html)
=======
<<<<<<< HEAD
- [`ampute` in `mice`](https://github.com/stefvanbuuren/mice/blob/ampute/R/Ampute.R) - [vignette](https://gerkovink.github.io/Amputation_with_Ampute/Vignette/ampute.html)
=======
- [`ampute` in `mice`](https://github.com/stefvanbuuren/mice/blob/ampute/R/Ampute.R) - [vignette]( https://github.com/RianneSchouten/Amputation_with_Ampute/blob/master/Vignette/ampute.html)
>>>>>>> origin/master
>>>>>>> Stashed changes
